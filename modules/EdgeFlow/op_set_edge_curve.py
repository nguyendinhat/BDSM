...
class BDSM_Mesh_Edge_Curver(bpy.types.Operator, op_set_edge_flow.SetEdgeLoopBase):
    bl_idname = "mesh.bdsm_mesh_edge_curve"
    bl_label = "BDSM Mesh Edge Curve"
    bl_options = {'REGISTER', 'UNDO'}
    bl_description = 'BDSM Mesh Set Flow Mode\n'\
                    'Adjust edge loops to loop curvature\nALT: reuse last settings'
    ...
    def invoke(self, context, event):
        ...
        super(BDSM_Mesh_Edge_Curver, self).invoke(context)
