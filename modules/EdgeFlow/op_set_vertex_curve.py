...
class BDSM_Mesh_Vertex_Curve(bpy.types.Operator):
    bl_idname = "mesh.bdsm_mesh_vertex_curve"
    bl_label = "BDSM Mesh Vertex Curve"
    bl_options = {'REGISTER', 'UNDO'}
    bl_description = ''''BDSM Mesh Vertex Curve
    Curves vertices between the selected vertices in picking order of the selected vertices.
