...
class BDSM_Mesh_Face_Visual_Axis(bpy.types.Operator):
    """Tooltip"""
    bl_idname = "mesh.bdsm_mesh_face_visual_axis"
    bl_label = "BDSM Mesh Face Visual Axis"
    ...
    prop_edge: IntProperty(
        name="Edge Index",
        description="The edge used for defining X axis",
        default=0,
        min=0
    )
    ...
    prop_axis_size: FloatProperty(
        name="Axis Size",
        description="Define the Axis Size",
        default=10,
        step=10,
        min=0
    )
    ...
    prop_remove: BoolProperty(
        name="Remove Axis",
        description="You can remove the axis by checking this box, or run the tool again without any selected face",
        default=False,
    )
    ...
    def pro2(self, context, bm):
        if BDSM_Mesh_Face_Visual_Axis.handle != None:
            guiva.handle3d = BDSM_Mesh_Face_Visual_Axis.handle
            guiva.draw_handle_remove()
            BDSM_Mesh_Face_Visual_Axis.handle = None
        ...
        BDSM_Mesh_Face_Visual_Axis.handle = guiva.handle3d
        f1 = sel[0]
        sn = f1.normal
