...
class BDSM_Mesh_Face_Quick_Bridge(bpy.types.Operator):
    """Tooltip"""
    bl_idname = "mesh.bdsm_mesh_face_quick_bridge"
    bl_label = "BDSM Mesh Face Quick Bridge"
    ...
    prop_cut: IntProperty(
        name="Number of cuts",
        description="Define the number of cuts",
        default=3,
        min=1
    )    
    ...
    prop_rotation: FloatProperty(
        name="Rotation",
        description="Rotation along the bridge",
        default=0,
    )    


    prop_auto_fit: BoolProperty(
        name="Auto Fit Rotation",
        description="Auto Fit the endpoints",
        default=True,
    )    
    ...
    prop_simple: BoolProperty(
        name="Circular mode",
        description="Simple fit by circular center of two faces",
        default=False,
    )    
