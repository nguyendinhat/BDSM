...
def draw_3d(self, context):
    global lines
    global lines2
    draw_line(lines, (0.19, 1, 0.65, 1), True, True,1.8)
    draw_line(lines2, (0.94, 0.11, 0.12, 1), True, True, 4)
...
def draw_text(pos, text):
    ...
    if bpy.app.version < (3, 5, 0):
        blf.size(font_id, math.floor(12 * sc), 72)
    else:
        blf.size(font_id, math.floor(12 * sc))
