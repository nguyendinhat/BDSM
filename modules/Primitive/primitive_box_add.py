...
class BDSM_Mesh_PrimitiveBoxAdd(Operator):
    bl_idname = "mesh.bdsm_mesh_primitive_box_add"
    bl_label = "BDSM Mesh Primitive Box Add"
    bl_description = 'BDSM Mesh Primitive Box Add\n'\
                    "Creates a Box Primitive (from Blender Default Template)"
