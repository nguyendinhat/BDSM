...
def prefs_ui(self, layout):
    ...
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_cursor1')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_cursor2')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_construction_line')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_line_selected')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_pivot')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_vertex')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_vertex_selected')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_box_select')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_duplicate')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_line_bevel')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_circle_draw')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_main_edge')
    row = col.row()
    row.prop(self, 'kushiro_gridmodeler_color_eng')
