...
from .. utils.tools import get_selected
...
class BDSM_View_Axis(Operator):
    bl_idname = "view3d.bdsm_view_axis"
    bl_label = "BDSM View Axis"
    bl_description = "BDSM View Axis \nAxis view to nearest Orthographic. Note: No toggle - just rotate view back to perspective"
    bl_options = {'REGISTER'}
