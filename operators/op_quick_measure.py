...
from ..utils.tools import shift_list, get_midpoint, get_scene_unit, get_distance, set_status_text
...
def draw_callback_px(self, context):
    ...
    if self.help_mode:
        ui_help_entries = [
            (self.scol, self.fontsize[2], " "),
            (self.scol, self.fontsize[2], "Help:"),
            (self.scol, self.fontsize[2], "Change / Update Mode: (1)Verts, (2)Edges, (3)Faces, (4/TAB)Objects"),
            (self.scol, self.fontsize[2], "Stop: (Esc), (Enter), (Spacebar). Clear Sel: (Backspace) or space-click"),
            (self.scol, self.fontsize[2], "(W)rab, (E)otate, (R)cale"),
            (self.scol, self.fontsize[2], "Freeze Selection: (K),  Cycle Area Modes: (M),  Cycle Display Modes: (D)"),
...
class BDSM_Quick_Measure(Operator):
    bl_idname = 'view3d.bdsm_quick_measure'
    bl_label = 'BDSM Quick Measure'
    bl_description = 'BDSM Quick Measure\n'\
                    "Contextual measurement types by mesh selection (Obj & Edit modes).\n" \
                    "*Quick Measure FreezeMode* starts in freeze mode."
    ...
    def poll(cls, context):
        ...
        return (prefs.quickmeasure_running is False
    ...
    def quit_qm(self):
        ...
        self.ctx.preferences.addons['BDSM'].preferences.quickmeasure_running = False
    ...
    def invoke(self, context, event):
        ...
        self.hcol = prefs.modal_color_header
        self.tcol = prefs.modal_color_text
        self.scol = prefs.modal_color_subtext
        ...
        prefs.quickmeasure_running = True
