...
import mathutils,time, numpy, math,random

class BDSM_Object_Drop_It(Operator):
    bl_idname = 'object.bdsm_object_drop_it'
    bl_label = 'BDSM Object Drop It'
    bl_description = 'BDSM Object Drop It\n'\
                    'Objects that fall until they touch the ground\n '\
                    'or other surfaces will stop using linear simulation'
    ...
    WindowManager.surf_align = BoolProperty(default=True)
