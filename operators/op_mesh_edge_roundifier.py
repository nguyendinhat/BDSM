...
class BDSM_Mesh_Edge_Roundifier(Operator):
    bl_idname = "mesh.bdsm_mesh_edge_roundifier"
    bl_label = "BDSM Mesh Edge Roundifier"
    bl_description =("BDSM Mesh Edge Roundifier\n"
