...
class BDSM_Mesh_Deselect_Boundary(bpy.types.Operator):
    """Deselect boundary edges of selected faces"""
    bl_idname = "mesh.bdsm_mesh_deselect_boundary"
    bl_label = "BDSM Mesh Deselect Boundary"
    bl_description = "BDSM Mesh Deselect Boundary"
...
class BDSM_Mesh_Face_Cut(bpy.types.Operator):
    """Cut selected faces, connecting through their adjacent edges"""
    bl_idname = "mesh.bdsm_mesh_face_cut"
    bl_label = "BDSM Mesh Face Cut"
    bl_options = {'REGISTER', 'UNDO'}
