...
class BDSM_Mesh_Face_Inset_Fillet(Operator):
    bl_idname = 'mesh.bdsm_mesh_face_inset_fillet'
    bl_label = 'BDSM Mesh Face Inset Fillet'
    bl_description = ('BDSM Mesh Face Inset Fillet\n'
